...
| 기능 | 설명 | 구현 | 백엔드 | 테스트 |
|------|------|------|--------|--------|
| 프로젝트명 입력 | 필수 텍스트 입력 | ✅ | 🔗 | 🧪 projects.routes.test.ts |
| 프로젝트 코드 | 자동 생성 or 수동 입력 (대문자) | ✅ | 🔗 | 🧪 projects.routes.test.ts |
| 색상 선택 | 미리 정의된 색상 팔레트 | ✅ | 🔗 | 🧪 projects.routes.test.ts |
| 설명 입력 | 선택적 텍스트에어리어 | ✅ | 🔗 | 🧪 projects.routes.test.ts |
| 예산 설정 | 프로젝트 예산 숫자 입력 | ✅ | 🔗 (budget 필드) | 🧪 projects.routes.test.ts |
