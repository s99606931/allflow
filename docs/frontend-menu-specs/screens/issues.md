...
| 우선순위 뱃지 | P0(긴급)/P1/P2/P3 색상 뱃지 | ✅ | 🔗 | 🧪 |
| 상태 뱃지 | open / in-progress / resolved / closed | ✅ | 🔗 | 🧪 |
...
| 이슈 편집 | IssueEditDialog → PATCH | ✅ | 🔗 PATCH /issues/:id | 🧪 |
| 이슈 삭제 | sonner toast 확인 → DELETE | ✅ | 🔗 DELETE /issues/:id | 🧪 |
| 상태 전환 | 드롭다운 → 상태 변경 | ✅ | 🔗 PATCH /issues/:id (status) | 🧪 |
...
| 상태 필터 | open/in-progress/resolved 필터 | ✅ | 🔌 | 🧪 |
| 검색 | 제목 텍스트 검색 | ✅ | 🔌 | 🧪 |
...
| 기능 | 설명 | 구현 | 백엔드 | 테스트 |
|------|------|------|--------|--------|
| AI 자동 분류 | 이슈 내용 기반 카테고리 자동 분류 | ✅ | 🔗 POST /issues/ai-classify | 🧪 |
