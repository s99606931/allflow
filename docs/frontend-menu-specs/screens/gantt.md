...
| 프로젝트 그룹핑 | 프로젝트별로 태스크 그룹 표시 | ✅ | 🔗 GET /projects | 🧪 gantt.routes.test.ts |
...
| 기능 | 설명 | 구현 | 백엔드 | 테스트 |
|------|------|------|--------|--------|
| 의존성 화살표 표시 | SVG 화살표로 태스크 간 의존성 시각화 | ✅ | 🔗 GET /gantt/dependencies | 🧪 gantt.routes.test.ts |
...
| 순환 의존성 방지 | A→B→A 같은 순환 시 422 오류 | ✅ | 🔗 (422 응답) | 🧪 gantt.routes.test.ts |
