...
| BE-C3 | `PATCH /users/me` (name/avatar/locale) | unit + integration test PASS | — | 0.5d | ☐ todo |
...
마지막 측정: 2026-04-29 (loop iter 1 — BE-C5 완료)
다음 측정: loop iter 2 (예상: BE-C3 또는 BE-C1)
