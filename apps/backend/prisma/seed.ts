 ...
 * 정책:
 *   - upsert 기반 (재실행 안전, 멱등)
 *   - frontend opaque ID(`me`/`u1`/`p1`/`T-1024`/`ISS-241` 등)를 그대로 사용
 *   - 8 프로젝트 / 30+ 태스크 acceptance 충족하도록 fixtures 보강
 */
...
const ISSUES: SeedIssue[] = [
  {
    id: 'ISS-241',
    title: 'iOS 15.4에서 푸시 알림 수신 실패 (간헐적)',
    proj: 'p1',
    projColor: '#5B6CFF',
    sev: 'critical',
    prio: 'P0',
